...
function Footer({ user }: { user: IUser }) {
  ...
  return (
    <div
      className="bg-gradient-to-br from-[#1f1f1f] to-[#0f0f0f] w-full text-gray-300
    z-40 py-12 border-t border-gray-700"
    >
      <div
      ...
      >
        <div className="space-y-3">
          <h2
            className="text-white text-3xl font-bold cursor-pointer tracking-wide hover:text-blue-400
            transition"
            onClick={() => router.push("/")}
          >
            VyaparX
